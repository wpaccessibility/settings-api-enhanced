...
require_once( SAE_ABSPATH . 'wp-admin/includes/options-reading.php' );

add_settings_fields_options_reading();
...
add_action('admin_head', 'sae_options_reading_add_js');
...
<?php sae_do_settings_sections( 'reading' ); ?>
